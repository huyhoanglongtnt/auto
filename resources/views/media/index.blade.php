...
@section('content')
<div class="container">
    <h2>Thư viện ảnh của {{ class_basename($model) }} #{{ $model->id }}</h2>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Thông tin hình ảnh</h5>
        ...
        <div class="modal-footer">
            <!-- 2 nút: xoá liên kết + xoá hoàn toàn -->
            <button id="detachMedia" class="btn btn-warning">Xoá liên kết</button>
...
// Xoá liên kết (detach)
$('#detachMedia').on('click', function() {
    if (!selectedMediaId) return;
    $.ajax({
        url: `/admin/${currentType}/${currentId}/media/${selectedMediaId}`,
        type: 'DELETE',
